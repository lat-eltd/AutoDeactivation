...
<#x>
<?php
\srag\Notifications4Plugin\AutoDeactivation\x\Repository::getInstance()->installTables();
?>
```
 ...
 * ...
 *
 * @ilCtrl_isCalledBy srag\Notifications4Plugin\AutoDeactivation\x\Notification\NotificationsCtrl: x
 */
class x
{
    ...
...
// Your class must implement the interface `srag\Notifications4Plugin\AutoDeactivation\x\Sender\Sender`
```
