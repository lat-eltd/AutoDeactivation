...
use ilSession;
use ilUtil;
use srag\DIC\AutoDeactivation\DICStatic;
 ...
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\AutoDeactivation\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
