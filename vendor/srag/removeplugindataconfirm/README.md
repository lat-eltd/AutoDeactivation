...
```php
//...
use srag\RemovePluginDataConfirm\AutoDeactivation\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\AutoDeactivation\x\RepositoryObjectPluginUninstallTrait;
//...
